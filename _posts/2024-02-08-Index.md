...
<body>
    <div id="deck-builder" class="deck-builder"></div> <!-- Moved to the top -->
    <div id="cards"></div>
    <script>
        var cardData = {
    "items": [
    ...
    },
    {
      ...
      "rarity": "common"
        ...
        function displayCards() {
            ...
            cardData.items.forEach(function(card) { // removed .concat(cardData.supportItems) since it's not defined
