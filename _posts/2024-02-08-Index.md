...
<body>
    ...
    <!-- Additional container for displaying the opened deck separately -->
...
{}
    ...
    selectedDeckArea.innerHTML = `<h3>${deckName}</h3>`; // Display the name of the deck
   // Create a container for the cards in the selected deck
