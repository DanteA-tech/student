...
<body>
    <div class="sort-buttons">
        <button onclick="sortCards('elixir')">Sort by Elixir</button>
        <button onclick="sortCards('rarity')">Sort by Rarity</button>
    </div>
    ...
    },
    {
      ...
      "rarity": "common"
        ...
        function sortCards(criteria) {
            if (criteria === 'elixir') {
                cardData.items.sort((a, b) => a.elixirCost - b.elixirCost);
            } else if (criteria === 'rarity') {
                const rarityOrder = ['common', 'rare', 'epic', 'legendary', 'champion'];
                cardData.items.sort((a, b) => rarityOrder.indexOf(a.rarity) - rarityOrder.indexOf(b.rarity));
            }
            displayCards();
        }
